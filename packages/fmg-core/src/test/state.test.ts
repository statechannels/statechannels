...
describe("State", () => {
  ...
  const channelType = new Wallet("4f3edf983ac636a65a842ce7c78d9aa706d3b113bce9c46f30d7d21715b23b1d").address;
  // private keys are from the accounts generated by `ganache-cli -d`
  const participantA = new Wallet("6cbed15c793ce57650b9877cf6fa156fbef513c4e6134f022a85b1ffdd59b2a1");
  const participantB = new Wallet("6370fd033278c143179d81c5526140625662b8daa446c22ee2d73db3707e620c");
