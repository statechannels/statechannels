---
id: version-0.3.0-client-api-schema
...
|  [parseErrorResponse(jsonBlob)](./client-api-schema.parseerrorresponse.md) | Validates an error response against the API schema &amp; returns the input cast to the correctly narrowed type. |
...
|  [ChallengeChannelError](./client-api-schema.challengechannelerror.md) |  |
...
|  [CreateChannelError](./client-api-schema.createchannelerror.md) |  |
...
|  [GetStateError](./client-api-schema.getstateerror.md) |  |
...
|  [JoinChannelError](./client-api-schema.joinchannelerror.md) |  |
...
|  [PushMessageError](./client-api-schema.pushmessageerror.md) |  |
...
|  [WalletReady](./client-api-schema.walletready.md) |  |
