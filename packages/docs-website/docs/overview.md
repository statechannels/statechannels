...
There's an autogenerated [API reference](/contract-api/contract-inheritance.mdx) for the contracts, as well as a [quick-start](/protocol-docs/quick-start) guide and [implementation notes](/implementation-notes/contract-devs-intro).
