...
export default class GameFooter extends React.PureComponent<Props> {
  renderResignButton(resign, isNotOurTurn) {
    return (
      <Button
        className="footer-resign navbar-button mr-auto"
        outline={true}
        onClick={resign}
  ...
  renderChallengeButton(createBlockchainChallenge, canChallenge) {
    return (
      <Button
        className="footer-challenge navbar-button ml-auto"
        outline={true}
      ...
      <div>
        <Navbar className="game-bar fixed-top">
          ...
          <div className="container">
            ...
            <span className="col-2 opponent-name">
              {opponentName}
              <TheirMarker you={this.props.you} />
            </span>
          </div>
  ...
  render() {
    ...
    return this.renderResultAndButtonsAndDots(
      result,
      resign,
      createBlockchainChallenge,
      isNotOurTurn,
