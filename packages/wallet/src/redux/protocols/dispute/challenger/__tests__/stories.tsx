...
addStories(scenarios.challengeTimesOutAndIsDefunded, "Dispute Challenger / Challenge times out", Dispute);
...
addStories(scenarios.userDeclinesChallenge, "Dispute Challenger / User declines challenge", Dispute);
