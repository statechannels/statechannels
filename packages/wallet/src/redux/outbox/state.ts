...
export type MessageOutbox = Array<WalletEvent | JsonResponseAction>;
...
export function getLastMessage(state: OutboxState): WalletEvent | JsonResponseAction | undefined {
