...
export const OWN_COMMITMENT_RECEIVED = "ENGINE.CHANNEL.OWN_COMMITMENT_RECEIVED";
...
export const OPPONENT_COMMITMENT_RECEIVED = "ENGINE.CHANNEL.OPPONENT_COMMITMENT_RECEIVED";
