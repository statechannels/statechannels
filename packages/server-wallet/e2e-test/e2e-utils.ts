...
export const payerConfig: ServerWalletConfig = {...processEnvConfig, postgresDBName: 'payer'};
export const receiverConfig: ServerWalletConfig = {...processEnvConfig, postgresDBName: 'receiver'};
