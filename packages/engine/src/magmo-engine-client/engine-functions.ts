 ...
 * @param iFrameId The id of the embedded engine iframe.
 * @param state The data that was signed.
 ...
 * @param iFrameId The id of the embedded engine iframe.
 * @param state The state for the engine to sign.
 * @returns {Promise<string>} A promise that resolves to the signature generated by the engine.
 */
export async function signState(iFrameId: string, state: State): Promise<string> {
  const iFrame = document.getElementById(iFrameId) as HTMLIFrameElement;
 ...
 * @param iFrameId The id of the embedded engine iframe.
 * @param responseState The response to the challenge from the other user.
 */
export function respondToOngoingChallenge(iFrameId: string, responseState: State) {
  const iFrame = document.getElementById(iFrameId) as HTMLIFrameElement;
