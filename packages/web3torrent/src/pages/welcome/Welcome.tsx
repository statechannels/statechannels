  ...
  return (
    <section className="section fill">
      ...
      <div className="subtitle">
        <p>
          Web3Torrent brings crypto payments to the torrenting world. Under the hood it uses a
          paid-streaming extension to the{' '}
          ...
          files in a torrent swarm: and downloaders make micropayments to uploaders, for the data
          they provide.
        </p>
      </div>
