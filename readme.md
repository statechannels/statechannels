...
### Installing dependencies
  ...
  * **postgres** - we recommend [the postgres app](https://postgresapp.com/). Make sure you follow the following steps to add postgres tools to you $PATH, better verify commands like 'createdb', 'dropdb' runs correctly in your terminal before proceeding.
