...
export const ALLOCATION_2: Uint256[] = ['0x05', '0x05'];
export const DESTINATION_2: Address[] = [PARTICIPANT_1_ADDRESS, HUB_ADDRESS];
export const PARTICIPANTS_2: Address[] = [PARTICIPANT_1_ADDRESS, HUB_ADDRESS];
